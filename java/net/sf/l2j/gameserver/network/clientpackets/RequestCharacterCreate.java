...
public final class RequestCharacterCreate extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			//Create and Add Macro in Shortcut
			Macro.MacroCmd[] commands = new Macro.MacroCmd[1];
			commands[0] = new Macro.MacroCmd(3,3,0,0,".menu");
			player.getMacroList().registerMacro(new Macro(1000,3,"MENU","","MENU",commands));
			player.getShortcutList().addShortcut(new Shortcut(0,1,ShortcutType.MACRO,1000,-1,1));
		}
